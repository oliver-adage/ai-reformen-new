    ...
    <>
      <section className="lg:flex items-start">
        <div className="px-5 pt-8 pb-10 lg:px-8 lg:pb-12 lg:pt-14 lg:w-1/2">
          <h1 className="text-4xl font-medium lg:text-6xl mb-10 lg:mb-16">
          ...
          >
            <div>
              ...
              <p className="text-md opacity-45">
                Läs mer om stiftelsens syfte och grundare
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-md opacity-45">
                Läs om vår finansiering och stiftelsens donatorer
              </p>
            </div>
            <span className="block bg-black-5 text-black group-hover:bg-black group-hover:text-white p-3 rounded-full text-center text-nowrap w-24">
              Läs mer
      ...
      >
        ...
        <div className="text-center font-medium text-2xl px-5 py-4 lg:px-0 lg:py-5 max-w-4xl lg:text-5xl">
          <p className="mb-8">
          ...
          <p className="mb-8">
            Insamlingsstiftelsen Svenska AI-reformen har grundats med målet att
            ge svenska medborgare och organisationer tillgång till AI-verktyg
            som kan förbättra deras vardag och arbete, och därigenom bidra till
            samhällsnytta. Stiftelsen, som är teknologineutral och politiskt
            oberoende, fokuserar på att folkbilda om och tillgängliggöra
            AI-lösningar och sänka trösklarna för AI-användning, så att fler kan
            dra nytta av tekniken utan att behöva göra stora investeringar.
          </p>
          <p className="mb-8">
            Stiftelsens ändamål är att främja tillgång och kunskap till
            tillämpad AI för svenska medborgare och organisationer,
            företrädesvis inom offentlig sektor, skolor, universitet, forskning,
            icke-vinstdrivande organisationer och föreningar inom
            civilsamhället. Stiftelsen fokuserar på praktisk AI-användning som
            skapar samhällsnytta. AI-tjänsterna som förmedlas ska i huvudsak
            vara kostnadsneutrala, kunna nyttjas i stor skala och leda till ökad
      ...
      <section className="bg-blue text-white px-5 py-4 md:px-8 md:py-8">
        <div className="grid grid-cols-4 mb-8 lg:mb-16 lg:grid-cols-8 gap-5">
          <div className="col-span-4">
            ...
            <p className="text-lg text-white lg:text-2xl mb-6">
